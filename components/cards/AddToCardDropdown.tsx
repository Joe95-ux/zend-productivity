    ...
    <div className="absolute top-full right-0 mt-2 w-80 bg-white dark:bg-slate-800 rounded-lg shadow-lg border border-slate-200 dark:border-slate-700 z-50">
      {currentDropdownView === 'main' ? (
        ...
        <>
          ...
          {/* Sub-menu Content */}
          <div className="p-4">
            {currentDropdownView === 'labels' && <LabelDropdown card={card} boardId={boardId} sideOffset={-45} />}
            {currentDropdownView === 'dates' && <DueDateDropdown card={card} boardId={boardId} sideOffset={-45} />}
